...
namespace BeautySalonAPI.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCustomerBalance(int customerId)
        {
            ...
            //  Müşterinin SADECE aktif randevularını al (Cancelled ve NoShow hariç)
            ...
            //  Kalan borç ve fazla ödeme hesaplamaları 
            ...
            var balanceDto = new CustomerBalanceDto
            {
                ...
                TotalAgreedAmount = totalAgreedAmount, // sadece aktif randevular
                TotalPaidAmount = totalPaidAmount,
                PendingAmount = pendingAmount,
                RemainingDebt = remainingDebt, 
                OverPaid = overPaid,
                TotalPayments = payments.Count(p => p.Status == PaymentStatus.Paid),
