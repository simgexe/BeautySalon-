...
const Calendar = ({ 
  ...
  return (
    <div className={`${commonStyles.card} ${styles.calendarContainer}`}>
      {/* Calendar Header */}
      <div className={styles.calendarHeader}>
        <button
          onClick={onPrevMonth}
          className={`${commonStyles.btnSecondary} ${styles.navButton}`}
        >
          ◀ Önceki
        </button>
            ...
            >
              ...
              {dayAppointments.slice(0, 2).map((apt, i) => (
                <div
                  ...
                  style={{ backgroundColor: getStatusColor ? getStatusColor(apt.status) : '#4F46E5' }}
